...
Public Class Frm_consult_salida_alambron
    ...
    End Sub
    Private Sub Frm_consult_salida_alambron_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If (e.RowIndex >= 0) Then
            ...
            If (col = colVer.Name) Then
                ...
                Dim sql As String = "SELECT l.tipo,l.numero,l.cantidad,l.fec " & _
                                        "FROM J_salida_alambron_transaccion t , CORSAN.dbo.documentos_lin l   " & _
            ...
            ElseIf (col = colBorrar.Name) Then
                ...
                If (motivo <> "") Then
                    ...
                    sql = "UPDATE J_salida_alambron_enc SET anulado = 1,observaciones += '" & motivo & "' WHERE numero =" & numero
                    listSql.Add(sql)
    ...
    Private Sub cargarConsulta()
        ...
        End If
        selectSql = "SELECT E.numero,D.id_detalle,E.fecha,D.codigo,D.cantidad,(SELECT COUNT(numero) FROM J_salida_alambron_transaccion  WHERE numero = D.numero AND id_detalle = D.id_detalle) As entregado_rollos,E.solicita,E.observaciones " & _
                       "FROM J_salida_alambron_enc E ,J_salida_alambron_det D "
        ...
        If Not (chkTerminados.Checked) Then
            whereSql &= " AND (SELECT COUNT(numero) FROM J_salida_alambron_transaccion  WHERE numero = D.numero AND id_detalle = D.id_detalle)<D.cantidad "
        End If
    ...
    Private Sub pintarTerminadas()
        For i = 0 To dtgConsulta.RowCount - 1
            If Not IsDBNull(dtgConsulta.Item("cantidad", i).Value) Then
                If (dtgConsulta.Item("entregado_rollos", i).Value.ToString <> "") Then
                    If (dtgConsulta.Item("entregado_rollos", i).Value >= dtgConsulta.Item("cantidad", i).Value) Then
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        frm.Show()
        frm.Main(usuario, 0, "nod_salida_alambron")
    End Sub
