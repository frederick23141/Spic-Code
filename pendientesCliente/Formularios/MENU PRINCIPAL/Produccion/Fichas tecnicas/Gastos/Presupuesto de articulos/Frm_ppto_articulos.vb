    ...
    Private Sub guardarPpto()
        ...
        If (validar()) Then
            ...
            Else
                ...
                resp = MessageBox.Show("Ya existe presupeusto para: centro de costos " & cbo_centro.SelectedValue & " En el mes: " & cbo_mes.SelectedIndex + 1 & "-" & cbo_ano.Text & " desea sobre-escribirlo? ", "Modificar presupuesto", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                If resp = 6 Then
                    guardar()
                Else
                    llenarDtg()
