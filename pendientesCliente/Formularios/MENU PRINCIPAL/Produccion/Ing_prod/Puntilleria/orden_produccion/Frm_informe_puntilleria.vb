...
Public Class Frm_informe_puntilleria
    ...
    Private Sub Frm_informe_puntilleria_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_cbo()
    ...
    Private Sub cargarAdminProd(ByVal orden As String, ByVal codigo As String)
        ...
        If groupby = " group by" Then
            groupby = ""
        End If
        Dim sql As String = selectD & " FROM D_rollo_galvanizado_f R, D_orden_pro_galv_enc S,CORSAN.dbo.referencias ref,CORSAN.dbo.terceros ter  " & WhereFec & WhereCliExt & orderby & groupby
