...
Public Class frm_solicitud_trefsav
    ...
    Private Sub guardar()
        ...
        End If
        If (numeroExistente = 0) Then
            numero = objIngresoProdLn.consultar_valor("SELECT MAX (numero)  FROM J_salida_materia_prima_Tsav_enc ", "PRODUCCION") + 1
        Else
            numero = numeroExistente
        End If
        sqlDet = "DELETE FROM J_salida_materia_prima_Tsav_det WHERE numero =" & numero
        listSql.Add(sqlDet)
        sqlEnc = "DELETE FROM J_salida_materia_prima_Tsav_enc WHERE numero =" & numero
        listSql.Add(sqlEnc)
        sqlEnc = "INSERT INTO J_salida_materia_prima_Tsav_enc (numero,fecha,solicitante,observaciones,devolver) " & _
        ...
        For i = 0 To dtg_solicitud.RowCount - 1
            If (dtg_solicitud.Item(colDesc.Name, i).Value <> "") Then
                sqlDet = "INSERT J_salida_materia_prima_Tsav_det (numero,id_detalle,codigo,cantidad) VALUES " & _
