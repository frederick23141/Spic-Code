...
Class posicionar_messagebox
    ...
    Private Function checkWindow(ByVal hWnd As IntPtr, ByVal lp As IntPtr) As Boolean
        ...
        MoveWindow(hWnd, frmRect.Left + (frmRect.Width - dlgRect.Right + dlgRect.Left) \ 2, frmRect.Top + (frmRect.Height - dlgRect.Bottom + dlgRect.Top) \ 3, dlgRect.Right - dlgRect.Left, dlgRect.Bottom - dlgRect.Top, True)
        Return False
    End Function
